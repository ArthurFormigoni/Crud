...
public class UsuariosPremiumDAO extends Conexao {
    ...
    public boolean updateUserPremium(String nome,String senha , int pontos, String dt_nasc,String email , int userId){
        try {
            conectar();
