...
public class PowerupDAO extends Conexao {
    ...
    public boolean adicionar_poder(String nome, int preco, int quantidade){
        conectar();
        try{
            pstmt = getConn().prepareStatement("INSERT INTO Powerup (nome, quantidade, imagem_loja_url,  preco_moedas, initial_time, duracao, is_updated, is_deleted) VALUES (?, ?, 'url_powerup', ?, CURRENT_TIMESTAMP, INTERVAL '5 minutes', false, false)");
